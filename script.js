...
const I18N = {
  ja: {
    ...
    howto_3: "馬具を変えたい場合は「馬具設定」を開き、既存馬のIDを指定してコピーできます",
    howto_4: "「CSVを生成」を押すとタブ区切りのCSVができ、Sheetsにそのまま貼り付けられます",
    howto_5: "Xで共有したい場合は「Xシェア用にコピー」を押すと、タブ文字がXで潰れないよう｜区切りに変換してコピーされます",
  ...
  en: {
    ...
    howto_3: "To change gear, open \"Gear settings\" and copy from an existing horse by ID",
    howto_4: "Press \"Generate CSV\" to get a tab-separated CSV ready to paste into Sheets",
    howto_5: "To share on X, press \"Copy for X Sharing\" — it converts tabs to | separators so they survive posting",
